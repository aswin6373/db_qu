    ...
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <header className="sticky top-0 z-30 border-b border-line bg-canvas/85 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          <a className="flex items-center gap-2.5" href="#top">
            ...
            <span className="text-lg font-semibold tracking-tight text-ink">QueryMind</span>
          </a>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="rounded-md bg-brand-500/15 px-1.5 py-0.5 text-xs font-semibold text-brand-300">beta</span>
            </a>
            <button
      ...
      <main className="relative overflow-hidden" id="top">
        ...
        <div className="relative mx-auto max-w-5xl px-5 pb-16 pt-10 text-center sm:px-8 sm:pb-20 sm:pt-16 lg:pt-20">
          <p className="inline-flex items-center gap-2 rounded-full border border-brand-500/40 bg-brand-500/15 px-3.5 py-1.5 text-[13px] font-semibold text-brand-300">
            <Sparkles size={14} /> Now in public beta
          </p>
          <h1 className="mt-5 text-4xl font-semibold leading-[1.08] tracking-tight text-ink sm:text-6xl lg:text-7xl">
          ...
          <div className="mt-12 border-t border-line pt-8">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-8 gap-y-3">
              {["MySQL", "PostgreSQL", "MariaDB", "TiDB", "PlanetScale", "Amazon RDS"].map((name) => (
                <span className="text-[15px] font-semibold tracking-tight text-ink/35 transition hover:text-ink/60" key={name}>
                  {name}
                </span>
              ))}
            </div>
        ...
        <section className="relative border-t border-line bg-surface/60 px-5 py-12 sm:py-16 sm:px-8" id="how">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 grid gap-4 md:grid-cols-3">
              {[
                ...
                <div className="card-landing p-6" key={item.step}>
                  <span className="font-mono text-sm font-semibold text-brand-400">{item.step}</span>
            ...
            <div className="mx-auto mt-14 max-w-3xl">
              ...
              <h3 className="mt-2 text-center text-xl font-semibold tracking-tight text-ink sm:text-2xl">
