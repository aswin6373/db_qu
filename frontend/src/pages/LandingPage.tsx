      ...
      <header className="sticky top-0 z-30 border-b border-navy/5 bg-cream/85 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          ...
          <div className="flex items-center gap-3">
            <a
              className="hidden items-center gap-2 rounded-xl border border-navy/15 bg-white px-3.5 py-1.5 text-sm font-semibold text-navy shadow-sm transition hover:-translate-y-0.5 hover:shadow sm:inline-flex"
